      ...
      >
        <header className="glass sticky top-0 z-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3.5 flex items-center gap-3">
            <div className="w-9 h-9 bg-gradient-to-br from-primary to-accent rounded-xl flex items-center justify-center shadow-raised hover:shadow-glow transition-shadow duration-300">
